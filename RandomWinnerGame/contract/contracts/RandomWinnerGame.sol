...
// contract: 0x3F3421E19bbFf4030bc8af0bcd38509cC8548171
...
contract RandomWinnerGame is VRFConsumerBase, Ownable {
    ...
    // emitted when the game ends
    event ForceGameEnd(uint256 gameId, string endString);
   ...
   */
    ...
    */
    ...
    // forceEndGame is called to end gme forcefully if the game is not functioning as expected
    function forceEndGame() public onlyOwner{
        ...
        gameStarted = false;
        emit ForceGameEnd(gameId, "Current Game has been forcefully ended by contract owner");
